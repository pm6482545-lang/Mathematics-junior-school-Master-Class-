...
\begin{tcolorbox}[colback=white, colframe=primaryblue, title=\textbf{Concept Summary}, arc=0pt, outer arc=0pt]
    \textbf{Simultaneous Equations:} This is a set of equations that are satisfied by the same values of the variables.
    \begin{itemize}
...
\begin{center}
    \color{primaryblue}\textbf{Assessment Exercises (Mastery Level)} \\
    \textbf{SECTION A: SUBSTITUTION METHOD}
\end{center}

% Question 1
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt]
    \small\color{white}\textbf{Question 1 (Substitution)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    Solve: $y = 2x - 3$ and $x + y = 9$ & \\
    Substitute $y$ in the second equation: $x + (2x - 3) = 9$ & $M_1$ \\
    $3x - 3 = 9 \implies 3x = 12 \implies x = 4$ & $M_1$ \\
    $y = 2(4) - 3 = 5$ & \\
    Result: $\mathbf{x=4, y=5}$ & $A_1$ \\
\end{tabularx}

% Question 6
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt, before skip=10pt]
    \small\color{white}\textbf{Question 6 (Age Problems)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    A father is three times as old as his son. The sum of their ages is 48 years. Find their ages. & \\
    Let Son $= s$ and Father $= f$. & \\
    $f = 3s$ and $f + s = 48$ & $M_1$ \\
    $3s + s = 48 \implies 4s = 48 \implies s = 12$ & $M_1$ \\
    $f = 3(12) = 36$ & \\
    Result: $\mathbf{\text{Son } 12, \text{ Father } 36}$ & $A_1$ \\
\end{tabularx}

% Question 11
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt, before skip=10pt]
    \small\color{white}\textbf{Question 11 (Heads and Legs)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    ...
    $c + g = 20 \implies g = 20 - c$ & $M_1$ \\
    $2c + 4g = 50 \implies 2c + 4(20 - c) = 50$ & $M_1$ \\
    $2c + 80 - 4c = 50 \implies -2c = -30 \implies c = 15$ & \\
    Result: $\mathbf{15 \text{ chickens}}$ & $A_1$ \\
\end{tabularx}

\newpage
\begin{center}
    \color{primaryblue}\textbf{SECTION B: ELIMINATION METHOD}
\end{center}

% Question 1 Elimination
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt]
    \small\color{white}\textbf{Question 1 (Elimination)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    Solve: $x + y = 10$ and $x - y = 4$. & \\
    Add the two equations: $(x+x) + (y-y) = 10+4$ & $M_1$ \\
    $2x = 14 \implies x = 7$ & $M_1$ \\
    $7 + y = 10 \implies y = 3$ & \\
    Result: $\mathbf{x=7, y=3}$ & $A_1$ \\
\end{tabularx}

% Question 6 Elimination
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt, before skip=10pt]
    \small\color{white}\textbf{Question 6 (Hotel Bill)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    ...
    $2a + 3c = 4500$ & \\
    $2a + c = 3500$ & $M_1$ \\
    Subtract: $2c = 1000 \implies c = 500$ & $M_1$ \\
    $2a + 500 = 3500 \implies 2a = 3000 \implies a = 1500$ & \\
    Result: $\mathbf{\text{Adult: Sh. 1,500}}$ & $A_1$ \\
\end{tabularx}

% Question 11 Elimination
\begin{tcolorbox}[colback=black, colframe=black, sharp corners, boxrule=0.5pt, top=2pt, bottom=2pt, left=5pt, right=5pt, before skip=10pt]
    \small\color{white}\textbf{Question 11 (Parking Lot)}
\end{tcolorbox}
\begin{tabularx}{\textwidth}{X r}
    \textbf{Step-by-Step Working} & \textbf{Marking Scheme} \\
    In a parking lot, there are cars and motorcycles. Total vehicles are 30 and total wheels are 100. Find the number of cars. & \\
    $c + m = 30 \implies 2c + 2m = 60$ & $M_1$ \\
    $4c + 2m = 100$ & $M_1$ \\
    Subtract: $2c = 40 \implies c = 20$ & \\
    Result: $\mathbf{20 \text{ cars}}$ & $A_1$ \\
\end{tabularx}
