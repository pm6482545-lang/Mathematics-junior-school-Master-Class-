...
\usepackage{tikz}       
% Added '3d' and 'patterns' for Measurement shapes
\usetikzlibrary{shapes.geometric, positioning, arrows.meta, calc, patterns, 3d} 
\usepackage{pgfplots}             
...
% FIXED: Only ONE definition of solvingbox. 
% This version supports the Marking Scheme header automatically.
