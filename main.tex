...
\begin{tcolorbox}[colback=lightgrey, colframe=primaryblue, title=\textbf{Teacher's Concept: Vertical and Horizontal Lines}, arc=5pt]
    ...
    \begin{itemize}
        ...
        \item The \textbf{unwanted region} is usually shaded (or sometimes the wanted region, depending on the convention). Here, we shade the \textit{unwanted} region.
    \end{itemize}
\end{tcolorbox}
...
% Additional questions 4-6 follow same logic... 
\begin{solvingbox}{Question 4}
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw[ultra thick, primaryblue] (-1,5) -- (5,-1) node[above right, pos=0.2] {$x+y=4$};
\end{tikzpicture} \hfill $A_1$
\end{solvingbox}
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw[thick,->] (0,-3) -- (0,3.5) node[above] {$y$};
    \fill[pattern=north west lines, pattern color=red!30] (-2, -3) -- (-2, 3) -- (3, 3) -- (0.5, -2) -- cycle;
...
\begin{tikzpicture}[scale=0.6]
    ...
    \fill[pattern=north west lines, pattern color=red!30] (-1, -2) -- (-1, 5) -- (2.5, 5) -- cycle;
